...
export const LegacyMarkup: Story = {
    render: (args) => (
        `<div class="ds_accordion" data-module="ds-accordion"><button data-accordion="accordion-open-all" type="button" class="ds_link  ds_accordion__open-all  js-open-all">Open all <span class="visually-hidden">sections</span></button>
            <div class="ds_accordion-item">
                ...
                <div class="ds_accordion-item__header">
                    <h3 id="panel-1-heading" class="ds_accordion-item__title">Healthcare for veterans</h3>
            ...
            <div class="ds_accordion-item">
                ...
                <div class="ds_accordion-item__header">
                    <h3 id="panel-2-heading" class="ds_accordion-item__title">Employability for veterans</h3>
                    <span aria-hidden="true"  class="ds_accordion-item__indicator"></span>
            ...
            <div class="ds_accordion-item">
                ...
                <div class="ds_accordion-item__header">
                    <h3 id="panel-3-heading" class="ds_accordion-item__title">Housing for veterans</h3>
                    <span aria-hidden="true"  class="ds_accordion-item__indicator"></span>
